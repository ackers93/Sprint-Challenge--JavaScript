...
const unisWithUni = [
  ...
  graduates.filter((items) => {
    return items.university.includes("Uni");
  })
];
...
*/
const populationTotal = zooAnimals.reduce((accumulator, items) => {
  return accumulator + items.population;
}, 0);;
